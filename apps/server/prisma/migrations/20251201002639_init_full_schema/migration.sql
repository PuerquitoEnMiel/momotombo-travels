...
-- CreateEnum
CREATE TYPE "PriceLevel" AS ENUM ('FREE', 'LOW', 'MEDIUM', 'HIGH', 'LUXURY');
...
-- CreateTable
CREATE TABLE "_AmenityToDestination" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL
);
...
-- CreateIndex
CREATE UNIQUE INDEX "_AmenityToDestination_AB_unique" ON "_AmenityToDestination"("A", "B");

-- CreateIndex
CREATE INDEX "_AmenityToDestination_B_index" ON "_AmenityToDestination"("B");
...
-- AddForeignKey
ALTER TABLE "_AmenityToDestination" ADD CONSTRAINT "_AmenityToDestination_A_fkey" FOREIGN KEY ("A") REFERENCES "Amenity"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_AmenityToDestination" ADD CONSTRAINT "_AmenityToDestination_B_fkey" FOREIGN KEY ("B") REFERENCES "Destination"("id") ON DELETE CASCADE ON UPDATE CASCADE;
